...
const navigation = [
  {
    name: "About",
    href: "https://github.com/gvzdv/companion-app",
    current: false,
  },
];
          ...
          <div className="flex flex-1 items-center justify-start">
            <div className="flex flex-shrink-0 items-center">
              <Image
                ...
                src="https://avatars.githubusercontent.com/u/44172510?v=4"
                alt="Mike Gvozdev"
              />
              <Image
                width={0}
            ...
            <div className="ml-6">
              <div className="flex space-x-2 sm:space-x-4">
                ...
                <div className="px-3 py-2 text-gray-300">
                  <iframe
                    src="https://ghbtns.com/github-btn.html?user=gvzdv&repo=companion-app&type=star&count=true"
                    frameBorder="0"
                    scrolling="0"
                    width="150"
                    height="20"
